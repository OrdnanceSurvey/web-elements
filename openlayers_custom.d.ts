...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/e142871cb2cd8b98465117077302272aaeeed3a8/openlayers/openlayers.d.ts
...
declare module olx {
  ...
  module interaction {
    ...
    interface IDrawInteractionOptions {
...
declare module ol {
  ...
  module events {
    ...
    interface ConditionType { (evt: ol.MapBrowserEvent): boolean }
  }
  ...
  module interaction {
    ...
    interface DrawGeometryFunctionType { (coordinates: ol.Coordinate | ol.Coordinate[] | ol.Coordinate[][], opt_geometry?: ol.geom.SimpleGeometry): ol.geom.SimpleGeometry }

    class abc {
      //constructor(asd: ol.Coordinate)
    }
